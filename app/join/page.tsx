...
export default function JoinPage() {
  ...
  async function onJoin() {
    ...
    const res = await fetch("/api/rooms/join", {
      ...
      body: JSON.stringify({ code: cleanCode, contributionText: contributionText.trim() }),
    });
        ...
        <section className="relative z-10 flex min-h-screen items-center justify-center px-4">
          <div className="w-full max-w-md rounded-3xl border border-yellow-500/25 bg-yellow-500/8 p-8 backdrop-blur text-center">
            ...
            <p className="mt-3 text-sm text-white/70 leading-relaxed">
              Esta sala es <span className="text-yellow-300 font-semibold">cerrada</span>.{" "}
              Tu solicitud fue enviada y está esperando que el Owner o un Admin te apruebe.
            </p>
  ...
  return (
    <main className="relative min-h-screen overflow-hidden text-white">
      ...
      <section className="relative z-10">
        <div className="mx-auto flex min-h-screen max-w-6xl items-center px-4 pb-14 sm:px-6">
